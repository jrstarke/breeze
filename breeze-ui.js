...
(function() {
  var BusRouteLayer, BusStopLayer, DistanceLayer, Layer, RentalsLayer, busClusterSize, busRouteLayer, busSize, busStopLayer, distanceLayer, headerToggle, injectLocations, loadBusRoutes, loadRentals, map, polymaps, recordEvent, recordOutboundLink, rentalLayer, rentalSize, setVariable, setupDistanceSlider, setupPriceSlider, setupRoomsSlider, setupSharedCheckbox, toggleAdditional, trackEvent,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  rentalSize = Modernizr.touch ? 12 : 8;

  busSize = 3.5;

  busClusterSize = 5;

  injectLocations = function(stops, points) {
    return stops.forEach(function(stop) {
      var location;
      location = points[stop.p];
      stop.lat = location.lat;
      return stop.lon = location.lon;
    });
  };
  ...
  if (Modernizr.svg && Modernizr.inlinesvg) {
    ...
    if (!($(window).width() < 600 || $.cookie("survey-closed") || $.cookie("survey-visited"))) {
      $(".message").show();
    }
    if (Modernizr.touch) {
      $(".github").hide();
    ...
    BusRouteLayer = (function(_super) {
      ...
      BusRouteLayer.prototype.addRoutes = function(routes, points) {
        var _this = this;
        this.line = function(route) {
          var _this = this;
          return svgLine(route.map(function(routePoint) {
            return _this.map.locationPoint(points[routePoint]);
          }));
        };
    ...
    RentalsLayer = (function(_super) {
      ...
      RentalsLayer.prototype.addRentals = function(rentals) {
        ...
        marker.append("rect").attr("class", this.rentalClass).attr("x", -1 * rentalSize / 2).attr("y", -1 * rentalSize / 2).attr('height', rentalSize).attr('width', rentalSize).attr("text", function(rental) {
    ...
    $(".message .close").on("click", function() {
      $(".message").hide();
      $.cookie("survey-closed", true, {
        expires: 5
      });
      return trackEvent('Survey Closed');
    });
